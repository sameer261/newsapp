...
import 'package:news/utils/colors.dart'; // Add this for using social media icons
...
class Newspage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // If article category is null or empty, provide a fallback message
    String categoryDisplay = article.category?.join(", ") ?? "No Category";
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(article.imageUrl), // Set the image URL
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    categoryDisplay, // Display categories as a comma-separated string
                    style: TextStyle(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Display pubDate
                  Text(
                    article.pubDate, // Display publication date
                    style: TextStyle(
                      color: Color(0xFFB8B8B8), // Light gray color
                      fontSize: 12,
                      fontWeight: FontWeight.w400,
